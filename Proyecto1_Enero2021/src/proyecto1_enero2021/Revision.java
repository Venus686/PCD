...
/**
 *La clase Revision  se usará para controlar la entrada de los
...
public class Revision {
    ...
    public synchronized void entraPracticas(Practicas p) throws InterruptedException{
    ...
    public synchronized void salePracticas(Practicas p){
        estudiantes_practica--;
        profesores_ocupados--;
